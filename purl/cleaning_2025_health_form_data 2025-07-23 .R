...
# health_assess_2025 <- health_assess_2025 %>% select(`Site Number or Initial: JC-W-_______`, plant_number, `Any additional notes?`)
# 
...
view_height <- health_assess_2025 %>% select(plant_number, dbh_cm, plant_height_ft, densio_north, `Any additional notes?`)
