...
do_hypoth2_analysis <- function(data, predictor, response, xlabel, ylabel, color = "black") {
  ...
  p_text <- paste0("p-value = ", round(p_value, 4))
...
## Across all years, there is a positive correlation between base canker area and DBH, but no correlation with trunk canker area.
...
## However, in 2024 alone, there were no correlations in either base or trunk canker areas and DBH.
...
## In 2025 data alone, we do see this positive correlation in base canker area. And a slight positive correlation with trunk canker area.
