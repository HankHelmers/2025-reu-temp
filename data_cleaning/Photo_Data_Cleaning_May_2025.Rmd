...
# In this version of the form, all the camera information was in a single input field.
# So, we needed to seperate first, last photo and camera by '-':
may_photos <- may_photos %>% separate(col = first_photo, into = c('first_photo', 'last_photo', 'Camera'), sep = "-")

# Some were missing the camera, but we know from checking the photos that they are 
# on this camera: 
