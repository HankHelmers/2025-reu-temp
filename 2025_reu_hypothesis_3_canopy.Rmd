...
- Variables: Canker area → Percent_live_canopy
...
patterns_across_all_base <- do_hypoth3_analysis(
...
patterns_across_all_trunk <- do_hypoth3_analysis(
  data = combined_2024_2025, 
...
(patterns_across_all_base + patterns_across_all_trunk) + plot_layout(guide = "collect")
```
...
seedlings_combined <- combined_2024_2025 %>% filter(is.na(dbh_cm))
...
(patterns_across_seedlings_base + patterns_across_seedlings_trunk) + plot_layout(guide = "collect")
```
...
adults_combined <- combined_2024_2025 %>% filter(!is.na(dbh_cm))

patterns_across_adults_base <- do_hypoth3_analysis(
  data = adults_combined, 
  predictor = "base_canker_area", 
  response = "percent_live_canopy",
  xlabel = "% of Base Canker Area in Adults",
  ylabel = "% Live Canopy",
  color = hex[3],
  color_points = "seedling_y_n"
)
...
patterns_across_adults_trunk <- do_hypoth3_analysis(
  ...
  predictor = "trunk_canker_area", 
  response = "percent_live_canopy",
  xlabel = "% of Trunk Canker Area in Adults",
  ylabel = "% Live Canopy",
  color = hex[4],
  color_points = "seedling_y_n"
)
...
(patterns_across_adults_base + patterns_across_adults_trunk) + plot_layout(guide = "collect")
```
